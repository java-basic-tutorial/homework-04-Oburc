...
public class CoffeeMachineV2 extends CoffeeMachineV1 {
    ...
    public void addMilk(int milk) {this.milk = Math.min(this.milk + milk, milkReservoirCapacity);}
    ...
    public boolean makeLatte() { return makeCoffeeWithMilk(150);}
    public boolean makeCappuccino() { return makeCoffeeWithMilk(85);}
}
